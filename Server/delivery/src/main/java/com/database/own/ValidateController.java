...
//	@ResponseBody
//	public JsonResponse connectpath(@RequestParam(value = "packageID") String packageID, HttpServletRequest request,
...
//		int day = currentDate.getDayOfMonth(); // 17
//		int month = currentDate.getMonth().getValue(); // JUNE
